    ...
    <t-row>
      <t-col :xs="12" :xl="9">
        ...
        >
          ...
          <div id="stokeContainer" style="height: 351px; width: 100%" class="dashboard-chart-container"></div>
        </t-card>
      </t-col>
      <t-col :xs="12" :xl="3">
...
const renderStokeChart = () => {
  if (!stokeContainer) {
    const container = document.getElementById('stokeContainer');
    if (!container) return;
    stokeContainer = container;
  }
