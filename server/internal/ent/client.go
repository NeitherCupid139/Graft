...
func (c *Client) Use(hooks ...Hook) {
	for _, n := range []interface{ Use(...Hook) }{
		c.Permission, c.RefreshSession, c.Role, c.RolePermission, c.User, c.UserRole,
	} {
		n.Use(hooks...)
	}
}
...
type (
	hooks struct {
		Permission, RefreshSession, Role, RolePermission, User, UserRole []ent.Hook
	}
	inters struct {
		Permission, RefreshSession, Role, RolePermission, User,
