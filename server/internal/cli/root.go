...
func NewRootCommand() *cobra.Command {
	root := &cobra.Command{
		...
		Long:         "Graft uses explicit subcommands for database migration, local development orchestration, runtime smoke validation, and server startup. Running `graft` without a subcommand only prints help.",
