...
func (_c *RefreshSessionCreate) SetTokenID(v string) *RefreshSessionCreate {
...
func (_c *RefreshSessionCreate) SetReplacedByTokenID(v string) *RefreshSessionCreate {
...
func (_c *RefreshSessionCreate) SetNillableReplacedByTokenID(v *string) *RefreshSessionCreate {
	if v != nil {
...
func (_c *RefreshSessionCreate) check() error {
	...
	if _, ok := _c.mutation.TokenID(); !ok {
		return &ValidationError{Name: "token_id", err: errors.New(`ent: missing required field "RefreshSession.token_id"`)}
	}
